...
//----------------------------------------------------
int mmo_char_sync_timer(int tid, int64 tick, int id, intptr_t data)
{
	if (save_log)
...
// the character list into seprate chunks to prevent 1 big packet.
...
// int ping_login_server(int tid, int64 tick, int id, intptr_t data); //Disabled, no need anymore. [15peaces]
int send_accounts_tologin(int tid, int64 tick, int id, intptr_t data);
